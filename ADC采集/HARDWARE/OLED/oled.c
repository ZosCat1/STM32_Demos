...
//Y0-6,X0-128坐标，real要显示的变量,N保留小数点位数。
...
//功能描述：写入一组中文
//参数：显示的位置（x,y），y为页范围0～3，要显示的中文
void wenandisplay(void)
{
OLED_ShowCHinese16x16(0,2,0,wenan);
Delay(2000);
OLED_ShowCHinese16x16(16,2,1,wenan);  
 Delay(2000); 
OLED_ShowCHinese16x16(32,2,2,wenan);
  Delay(2000);
OLED_ShowCHinese16x16(48,2,3,wenan);
  Delay(2000);
OLED_ShowCHinese16x16(64,2,4,wenan);
  Delay(2000);
  OLED_ShowCHinese16x16(80,2,5,wenan);
  Delay(2000);
//========================================================//  
OLED_ShowCHinese16x16(0,4,6,wenan);
  Delay(2000);
OLED_ShowCHinese16x16(16,4,7,wenan);
  Delay(2000);
OLED_ShowCHinese16x16(32,4,8,wenan);
  Delay(2000);
OLED_ShowCHinese16x16(48,4,9,wenan);
  Delay(2000);
OLED_ShowCHinese16x16(64,4,10,wenan);
  Delay(2000);
OLED_ShowCHinese16x16(80,4,11,wenan);
  Delay(2000);
